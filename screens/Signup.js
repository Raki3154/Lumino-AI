...
const Signup = ({ navigation }) => {
  return (
    <View style={styles.container}>
      ...
      <CustomButton title="Sign up" onPress={() => navigation.navigate('Signin')} />

      <Text style={styles.or}>Or Signup with</Text>

      <Text style={styles.social}>Google        Github</Text>

      <Text style={styles.bottom}>
        Already have an account? <Text style={styles.blue}>Sign in</Text>
      </Text>
    </View>
  );
};
...
const styles = StyleSheet.create({
  ...
  link:{ fontSize:12, color:Colors.gray, marginTop:10 },
